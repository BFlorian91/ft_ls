...
/*   Updated: 2019/02/01 20:55:23 by alcaroff         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char	*pf_getwchar2(wchar_t c, char *ret)
{
...
char		*pf_getwstr(wchar_t *str, t_spe *e)
{
	...
	if (!str)
		return (NULL);
	ret = malloc(pf_strlen((char *)str) * 4 + 1);
	while (*str)
	{
